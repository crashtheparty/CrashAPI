...
public class BlockSound {
	...
	private static BlockSound BASALT = new BlockSound("BLOCK_BASALT_BREAK", Arrays.asList("BASALT", "POLISHED_BASALT", "SMOOTH_BASALT"));
	...
	private static BlockSound CANDLE = new BlockSound("BLOCK_CANDLE_BREAK", Arrays.asList("CANDLE", "WHITE_CANDLE", "ORANGE_CANDLE", "MAGENTA_CANDLE", "LIGHT_BLUE_CANDLE", "YELLOW_CANDLE", "LIME_CANDLE", "PINK_CANDLE", "GRAY_CANDLE", "LIGHT_GRAY_CANDLE", "CYAN_CANDLE", "PURPLE_CANDLE", "BLUE_CANDLE", "BROWN_CANDLE", "GREEN_CANDLE", "RED_CANDLE", "BLACK_CANDLE"));
	private static BlockSound COPPER = new BlockSound("BLOCK_COPPER_BREAK", Arrays.asList("OXIDIZED_COPPER", "WEATHERED_COPPER", "EXPOSED_COPPER", "COPPER_BLOCK", "OXIDIZED_CUT_COPPER", "WEATHERED_CUT_COPPER", "EXPOSED_CUT_COPPER", "CUT_COPPER", "OXIDIZED_CUT_COPPER_STAIRS", "WEATHERED_CUT_COPPER_STAIRS", "EXPOSED_CUT_COPPER_STAIRS", "CUT_COPPER_STAIRS", "OXIDIZED_CUT_COPPER_SLAB", "WEATHERED_CUT_COPPER_SLAB", "EXPOSED_CUT_COPPER_SLAB", "CUT_COPPER_SLAB", "WAXED_COPPER_BLOCK", "WAXED_WEATHERED_COPPER", "WAXED_EXPOSED_COPPER", "WAXED_OXIDIZED_COPPER", "WAXED_OXIDIZED_CUT_COPPER", "WAXED_WEATHERED_CUT_COPPER", "WAXED_EXPOSED_CUT_COPPER", "WAXED_CUT_COPPER", "WAXED_OXIDIZED_CUT_COPPER_STAIRS", "WAXED_WEATHERED_CUT_COPPER_STAIRS", "WAXED_EXPOSED_CUT_COPPER_STAIRS", "WAXED_CUT_COPPER_STAIRS", "WAXED_OXIDIZED_CUT_COPPER_SLAB", "WAXED_WEATHERED_CUT_COPPER_SLAB", "WAXED_EXPOSED_CUT_COPPER_SLAB", "WAXED_CUT_COPPER_SLAB", "LIGHTNING_ROD"));
	private static BlockSound AMETHYST = new BlockSound("BLOCK_AMETHYST_BLOCK_BREAK", Arrays.asList("AMETHYST_BLOCK", "BUDDING_AMETHYST"));
	private static BlockSound AMETHYST_CLUSTER = new BlockSound("BLOCK_AMETHYST_CLUSTER_BREAK", Arrays.asList("AMETHYST_CLUSTER", "LARGE_AMETHYST_BUD", "MEDIUM_AMETHYST_BUD", "SMALL_AMETHYST_BUD"));
	private static BlockSound TUFF = new BlockSound("BLOCK_TUFF_BREAK", Arrays.asList("TUFF"));
	private static BlockSound CALCITE = new BlockSound("BLOCK_CALCITE_BREAK", Arrays.asList("CALCITE"));
	private static BlockSound POWDER_SNOW = new BlockSound("BLOCK_POWDER_SNOW_BREAK", Arrays.asList("POWDER_SNOW"));
	private static BlockSound SCULK_SENSOR = new BlockSound("BLOCK_SCULK_SENSOR_BREAK", Arrays.asList("SCULK_SENSOR"));
	private static BlockSound DRIPSTONE = new BlockSound("BLOCK_DRIPSTONE_BREAK", Arrays.asList("DRIPSTONE_BLOCK"));
	private static BlockSound POINTED_DRIPSTONE = new BlockSound("BLOCK_POINTED_DRIPSTONE_BREAK", Arrays.asList("POINTED_DRIPSTONE"));
	private static BlockSound DEEPSLATE = new BlockSound("BLOCK_DEEPSLATE_BREAK", Arrays.asList("DEEPSLATE_COPPER_ORE", "DEEPSLATE", "COBBLED_DEEPSLATE", "COBBLED_DEEPSLATE_STAIRS", "COBBLED_DEEPSLATE_SLAB", "COBBLED_DEEPSLATE_WALL", "POLISHED_DEEPSLATE ", "POLISHED_DEEPSLATE_STAIRS", "POLISHED_DEEPSLATE_SLAB", "POLISHED_DEEPSLATE_WALL", "DEEPSLATE_TILES", "DEEPSLATE_TILE_STAIRS", "DEEPSLATE_TILE_SLAB", "DEEPSLATE_TILE_WALL", "DEEPSLATE_BRICKS", "DEEPSLATE_BRICK_STAIRS", "DEEPSLATE_BRICK_SLAB", "DEEPSLATE_BRICK_WALL", "CHISELED_DEEPSLATE", "CRACKED_DEEPSLATE_BRICKS", "CRACKED_DEEPSLATE_TILES", "INFESTED_DEEPSLATE", "DEEPSLATE_GOLD_ORE", "DEEPSLATE_IRON_ORE", "DEEPSLATE_COAL_ORE", "DEEPSLATE_LAPIS_ORE", "DEEPSLATE_DIAMOND_ORE", "DEEPSLATE_REDSTONE_ORE", "DEEPSLATE_EMERALD_ORE"));
	private static BlockSound CAVE_VINES = new BlockSound("BLOCK_CAVE_VINES_BREAK", Arrays.asList("CAVE_VINES", "CAVE_VINES_PLANT"));
	private static BlockSound SPORE_BLOSSOM = new BlockSound("BLOCK_SPORE_BLOSSOM_BREAK", Arrays.asList("SPORE_BLOSSOM"));
	private static BlockSound AZALEA = new BlockSound("BLOCK_AZALEA_BREAK", Arrays.asList("AZALEA"));
	private static BlockSound FLOWERING_AZALEA = new BlockSound("BLOCK_FLOWERING_AZALEA_BREAK", Arrays.asList("FLOWERING_AZALEA"));
	private static BlockSound MOSS_CARPET = new BlockSound("BLOCK_MOSS_CARPET_BREAK", Arrays.asList("MOSS_CARPET"));
	private static BlockSound MOSS = new BlockSound("BLOCK_MOSS_BREAK", Arrays.asList("MOSS_BLOCK"));
	private static BlockSound BIG_DRIPLEAF = new BlockSound("BLOCK_BIG_DRIPLEAF_BREAK", Arrays.asList("BIG_DRIPLEAF", "BIG_DRIPLEAF_STEM"));
	private static BlockSound SMALL_DRIPLEAF = new BlockSound("BLOCK_SMALL_DRIPLEAF_BREAK", Arrays.asList("SMALL_DRIPLEAF"));
	private static BlockSound HANGING_ROOTS = new BlockSound("BLOCK_HANGING_ROOTS_BREAK", Arrays.asList("HANGING_ROOTS"));
	private static BlockSound ROOTED_DIRT = new BlockSound("BLOCK_ROOTED_DIRT_BREAK", Arrays.asList("ROOTED_DIRT"));
	private static BlockSound STONE = new BlockSound("BLOCK_STONE_BREAK", Arrays.asList());
	private static List<BlockSound> SOUNDS = Arrays.asList(ROOTED_DIRT, HANGING_ROOTS, SMALL_DRIPLEAF, BIG_DRIPLEAF, MOSS, MOSS_CARPET, FLOWERING_AZALEA, AZALEA, SPORE_BLOSSOM, CAVE_VINES, DEEPSLATE, DRIPSTONE, POINTED_DRIPSTONE, SCULK_SENSOR, POWDER_SNOW, CALCITE, TUFF, AMETHYST_CLUSTER, AMETHYST, COPPER, CANDLE, GILDED_BLACKSTONE, NETHER_GOLD_ORE, CHAIN, LODESTONE, ANCIENT_DEBRIS, NETHERITE_BLOCK, BONE_BLOCK, NETHER_ORE, NETHER_SPROUTS, NETHER_BRICKS, NETHERRACK, WART_BLOCK, BASALT, SOUL_SOIL, SOUL_SAND, VINES, SHROOMLIGHT, ROOTS, FUNGUS, NYLIUM, STEM, ANVIL, WOOD, GRAVEL, GRASS, METAL, GLASS, WOOL, SAND, SNOW, LADDER, SLIME_BLOCK, HONEY_BLOCK, WET_GRASS, CORAL_BLOCK, BAMBOO, BAMBOO_SAPLING, SCAFFOLDING, SWEET_BERRY_BUSH, CROP, NETHER_WART, LANTERN);
	...
	private BlockSound(String sound, List<String> types, float volume, float pitch) {
		this.sound = sound;
		List<Material> sounds = new ArrayList<Material>();
		for(String s: types)
			try {
				sounds.add(Material.valueOf(s));
			} catch (Exception ex) {}
		this.types = sounds;
		this.volume = volume;
		this.pitch = pitch;
	...
	public static BlockSound getSound(Material m) {
		for(BlockSound sound: SOUNDS) {
			...
			for(Material type: sound.getTypes())
				if (type == m) return sound;
		}
		return STONE;
	}
}
