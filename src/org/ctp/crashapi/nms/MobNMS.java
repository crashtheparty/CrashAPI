...
public class MobNMS extends NMS {
	...
	public static Entity setNBTData(Entity entity, String s) {
		switch (getVersionNumber()) {
			...
			default:
				if (isSimilarOrAbove(getVersionNumbers(), 1, 20, 2)) return Mob_7.setNBTData(entity, s);
				...
				else if (isSimilarOrAbove(getVersionNumbers(), 1, 19, 0)) return Mob_3.setNBTData(entity, s);
