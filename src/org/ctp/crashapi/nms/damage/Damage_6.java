...
public class Damage_6 extends NMS {
	...
	public static void damageEntity(LivingEntity e, String cause, float damage) {
		try {
			...
			Method m = Entity.class.getDeclaredMethod("dN");
			...
			switch (cause) {
				case "drown":
					Method m2 = c1.getDeclaredMethod("h");
	...
	public static double getArrowDamage(LivingEntity le, AbstractArrow a) {
		...
		try {
			...
			Method m = c.getDeclaredMethod("di");
			...
			Method dm = cArrow.getDeclaredMethod("m");
