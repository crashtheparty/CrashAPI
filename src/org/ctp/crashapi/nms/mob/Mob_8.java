...
public class Mob_8 extends NMS {
	...
	public static Entity setNBTData(Entity entity, String s) {
		...
		try {
			...
			Method posVector = entityClass.getDeclaredMethod("dn");
			...
			Method setPosition = entityClass.getDeclaredMethod("c", double.class, double.class, double.class);
