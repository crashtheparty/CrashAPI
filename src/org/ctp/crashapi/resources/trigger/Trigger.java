 ...
 * All triggers must completed the requirements are explicitly specified using
 * {@link org.ctp.enchantmentsolution.crashapi.resources.advancements.Advancement#addRequirement(String...)}
 */
public abstract class Trigger {
	...
	public JsonObject toJson() {
		return new JsonBuilder().add("trigger", type.getValue()).add("conditions", getConditions()).build();
	}
	...
	public enum Type implements SharedEnum {
		BRED_ANIMALS, BREWED_POTION, CHANGED_DIMENSION, CONSTRUCT_BEACON, CONSUME_ITEM, CURED_ZOMBIE_VILLAGER,
		EFFECTS_CHANGED, ENCHANTED_ITEM, ENTER_BLOCK, ENTITY_HURT_PLAYER, ENTITY_KILLED_PLAYER, IMPOSSIBLE,
		INVENTORY_CHANGED, ITEM_DURABILITY_CHANGED, LEVITATION, LOCATION, NETHER_TRAVEL, PLACED_BLOCK,
		PLAYER_HURT_ENTITY, PLAYER_KILLED_ENTITY, RECIPE_UNLOCKED, SLEPT_IN_BED, SUMMONED_ENTITY, TAME_ANIMAL, TICK,
		USED_ENDER_EYE, USED_TOTEM, VILLAGER_TRADE;
