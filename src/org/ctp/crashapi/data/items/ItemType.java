	...
	private List<String> getEnchantables(String type) {
		...
		switch (type.toUpperCase()) {
			...
			case "LEGGINGS":
				...
				break;
			case "MELEE":
				i.addAll(getEnchantables(MACE.getType()));
